...
public class BuilderCollectionPotential {
	...
	public void makePairPotentialsUnlike(int speciesIndex1, int speciesIndex2){
		...
		for(int i = 0;i < 2;i++){
			...
			if(etomica.potential.Potential2SoftSpherical.class.isAssignableFrom(speciesDM[i].getPotential()) || PotentialSoft.class.isAssignableFrom(speciesDM[i].getPotential())){
