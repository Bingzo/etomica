...
public class SimOverlapSoftSphereSuperBox extends Simulation {
    ...
    public SimOverlapSoftSphereSuperBox(Space _space, int numAtoms, double density, double temperature, String filename, double harmonicFudge, int exponent) {
        ...
        potentialMasterTarget.addPotential(pTruncatedAA, new IAtomType[] { sphereTypeA, sphereTypeA });
        potentialMasterTarget.addPotential(pTruncatedAB, new IAtomType[] { sphereTypeA, sphereTypeB });
        ...
        potentialMasterTarget.addPotential(p1Constraint, new IAtomType[] {sphereTypeA});
