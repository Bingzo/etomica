...
public class IntegratorRigidMatrixIterative extends IntegratorMD implements AgentSource<IntegratorRigidMatrixIterative.AtomAgent>, SpeciesAgentManager.AgentSource, MoleculeAgentSource {
    ...
    public void setBox(IBox p) {
        ...
        super.setBox(p);
        leafAgentManager = new AtomLeafAgentManager<AtomAgent>(this,p,IntegratorVelocityVerlet.MyAgent.class);
...
//                    System.out.println("force: "+((MyAgent)a.ia).force.toString());
            ...
            for (int i=0; i<children.getAtomCount(); i++) {
                ...
                IVectorMutable atomForce = leafAgentManager.getAgent(atom).force;
                if (atomForce.isZero()) {
                    continue;
                }
...
//--------------------------------------------------------------
    ...
    public final AtomAgent makeAgent(IAtom a) {
    ...
    public static class MoleculeAgent implements Torquable, Forcible, Serializable {  //need public so to use with instanceof
    ...
    public static class AtomAgent implements Forcible, Serializable {  //need public so to use with instanceof
        private static final long serialVersionUID = 1L;
        ...
        public void actionPerformed() {
            ...
            for (int i=0; i<molecules.getMoleculeCount(); i++) {
                ...
                if (molecule instanceof MoleculeOrientedDynamic) {
                    IVectorMutable position = ((MoleculeOrientedDynamic)molecule).getPosition();
